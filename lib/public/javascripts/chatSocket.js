...
$(document).ready(function() {
    ...
    var addStoryEntry = function(entry) {
        var textBubble = $('<div class="textBubble" style="color:' + getUserColor(entry.nickname) + '">' + entry.text + '</div>');
    ...
    } else if (room.lastWriter != getNickname()) {
